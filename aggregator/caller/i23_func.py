...
def ind_caller(sci, results, logging, extra_aggr_param=[], working_path=""):
    ...
    try:
        results["i23"]["sv01"] = uf.secondary_view(
            sci, "pub_year", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    ...
    try:
        results["i23"]["sv02"] = uf.inner_secondary_view(
            sci, "topic", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23"]["sv03"] = uf.secondary_view(
            sci, "category", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23"]["sv05"] = uf.sdg_aggregation(
            sci, i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23"]["sv06"] = uf.inner_secondary_view(
            sci, "affiliations.affiliation_name", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        full_set = uf.inner_secondary_view(
            sci, "affiliations.country", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
        results["i23"]["sv09"] = {}
    ...
    try:
        results["i23"]["sv11"] = uf.secondary_view(
            sci, "publisher", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23"]["sv12"] = uf.inner_secondary_view(
            sci, "funders.funder", i23_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
