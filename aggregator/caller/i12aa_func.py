...
def remove_none_values(d):
    if isinstance(d, dict):
        return {k: remove_none_values(v) for k, v in d.items() if v is not None and v != {None: 0}}
    else:
        return d

def ind_caller(pat, final_results, logging, extra_aggr_param=[], working_path=""):
    final_results["i12a"] = {}
    ...
    try:    
        ...
        final_results["i12a"]["sv01"] = results["i12a"]["sv01"]
    except Exception as e:
    ...
    try:    
        ...
        final_results["i12a"]["sv02"] = results["i12a"]["sv02"]
    except Exception as e:
    ...
    try:
        ...
        numerator_FC.pop(None, None)
        numerator_BC.pop(None, None)
        denominator.pop(None, None)
        ...
        final_results["i12a"]["sv06"] = results["i12a"]["sv06"]
    except Exception as e:
    ...
    try:
        ...
        final_results["i12a"]["sv08"] = results["i12a"]["sv08"]
    except Exception as e:
    ...
    try:
        ...
        final_results["i12a"]["sv09"] = results["i12a"]["sv09"]
    except Exception as e:
