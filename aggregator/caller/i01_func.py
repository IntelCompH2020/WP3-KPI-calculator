...
def ind_caller(sci, results, logging, extra_aggr_param=[], working_path=""):
    ...
    try:
        results["i01"]["sv00"] = uf.secondary_view(
            sci, "all", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    ...
    try:
        results["i01"]["sv01"] = uf.secondary_view(
            sci, "pub_year", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
        results["i01"]["sv01"] = None
        print(f"Error calculating sv01: {str(e)}")
    ...
    try:
        results["i01"]["sv02"] = uf.inner_secondary_view(
            sci, "topic", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i01"]["sv03"] = uf.secondary_view(
            sci, "category", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
        print(results["i01"]["sv03"])
    except Exception as e:
    ...
    try:
        results["i01"]["sv05"] = uf.sdg_aggregation(
            sci, i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i01"]["sv06"] = uf.inner_secondary_view(
            sci, "affiliations.affiliation_name", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    full_set = uf.inner_secondary_view(
        sci, "affiliations.country", i01_aggregation, copy.deepcopy(extra_aggr_param)
    )
    results["i01"]["sv09"] = {}
    ...
    try:
        results["i01"]["sv11"] = uf.secondary_view(
            sci, "publisher", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i01"]["sv12"] = uf.inner_secondary_view(
            sci, "funders.funder", i01_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
