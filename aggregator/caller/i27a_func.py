...
def ind_caller(sci, results, extra_aggr_param=[], spark_output=""):
    ...
    try:
        results["i27a"]["sv01"] = uf.secondary_view(
            sci, "pub_year", i27a_aggregation, extra_aggr_param
        )
    ...
    try:
        results["i27a"]["sv02"] = uf.inner_secondary_view(
            sci, "topic", i27a_aggregation, extra_aggr_param
        )
    except Exception as e:
    ...
    try:
        results["i27a"]["sv03"] = uf.secondary_view(
            sci, "category", i27a_aggregation, extra_aggr_param
        )
    except Exception as e:
    ...
    try:
        results["i27a"]["sv05"] = uf.sdg_aggregation(
            sci, i27a_aggregation, extra_aggr_param
        )
    except Exception as e:
    ...
    try:
        results["i27a"]["sv06"] = uf.inner_secondary_view(
            sci, "affiliations.affiliation_name", i27a_aggregation, extra_aggr_param
        )
    except Exception as e:
    ...
    try:
        full_set = uf.inner_secondary_view(
            sci, "affiliations.country", i27a_aggregation, extra_aggr_param
        )
        results["i27a"]["sv09"] = {}
    ...
    try:
        results["i27a"]["sv11"] = uf.secondary_view(
            sci, "publisher", i27a_aggregation, extra_aggr_param
        )
    except Exception as e:
    ...
    try:
        results["i27a"]["sv12"] = uf.inner_secondary_view(
            sci, "funders.funder", i27a_aggregation, extra_aggr_param
        )
    except Exception as e:
