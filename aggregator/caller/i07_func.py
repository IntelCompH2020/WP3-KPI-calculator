...
def ind_caller(sci, results, logging, extra_aggr_param=[], working_path=""):
    results = i01_func.ind_caller(sci, results, logging, copy.deepcopy(extra_aggr_param), working_path)
    results = i06_func.ind_caller(sci, results, logging, copy.deepcopy(extra_aggr_param), working_path)
