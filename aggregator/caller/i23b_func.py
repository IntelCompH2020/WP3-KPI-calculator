...
def ind_caller(sci, results, logging, extra_aggr_param=[], working_path=""):
    ...
    try:
        results["i23b"]["sv01"] = uf.secondary_view(
            sci, "pub_year", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    ...
    try:
        results["i23b"]["sv02"] = uf.inner_secondary_view(
            sci, "topic", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23b"]["sv03"] = uf.secondary_view(
            sci, "category", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23b"]["sv05"] = uf.sdg_aggregation(
            sci, i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23b"]["sv06"] = uf.inner_secondary_view(
            sci, "affiliations.affiliation_name", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        full_set = uf.inner_secondary_view(
            sci, "affiliations.country", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
        results["i23b"]["sv09"] = {}
    ...
    try:
        results["i23b"]["sv11"] = uf.secondary_view(
            sci, "publisher", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
    ...
    try:
        results["i23b"]["sv12"] = uf.inner_secondary_view(
            sci, "funders.funder", i23b_aggregation, copy.deepcopy(extra_aggr_param)
        )
    except Exception as e:
